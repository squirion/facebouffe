...
const Map<String, Map<String, String>> kI18n = {
  'fr': {
    ...
    'fav_empty': 'Aucun favori pour l\'instant. Touchez le cœur ♥ d\'une recette pour l\'épingler ici.',
    ...
    'add_item': 'Ajouter un article', 'clear_checked': 'Effacer les cochés', 'clear_list': 'Vider la liste', 'clear_list_confirm': 'Vider toute la liste ?', 'items': 'articles', 'item': 'article',
    'to_buy': 'À acheter', 'in_cart': 'Dans le panier',
    'my_list': 'Ma liste', 'send_list': 'Envoyer la liste', 'send_to_friend': 'Envoyer à un ami',
    'send_confirm_title': 'Envoyer la liste ?', 'send_confirm_body': 'Envoyer ta liste d\'épicerie à @name ?',
    'sent_to': 'Envoyée à', 'list_received_title': 'Liste d\'épicerie reçue',
    'list_received_body': '@name t\'a envoyé une liste d\'épicerie.',
    'delete_list': 'Supprimer cette liste', 'delete_list_confirm': 'Supprimer cette liste ?',
    'list_frozen_note': 'Liste envoyée (lecture seule)',
    'send_offline': 'Envoi impossible — vérifie ta connexion.', 'send_empty': 'La liste est vide.',
    'list_sent': 'Liste envoyée à @name', 'no_friends_yet': 'Aucun ami pour l\'instant.',
    ...
    'import_photo_max': 'Maximum 5 images.',
    'import_err_multi_needs_online': 'L\'import de plusieurs images nécessite un fournisseur en ligne — ajoutez une clé API dans Paramètres avancés.',
    ...
    // crash reporting
    'crop_failed': 'Recadrage impossible',
    'photo_recovered': 'Photo récupérée',
    'crash_banner': 'L\'app semble avoir planté — envoyer un rapport ?',
    'crash_banner_send': 'Envoyer',
    'report_problem': 'Signaler un problème',
    'report_title': 'Signaler un problème',
    'report_notes_ph': 'Décrivez ce qui s\'est passé (optionnel)',
    'report_log_hint': 'Un journal technique anonyme sera joint',
    'report_send': 'Envoyer le rapport',
    'report_offline': 'Connexion requise pour envoyer',
    'report_sent': 'Merci ! Rapport envoyé',
    'report_failed': 'Échec de l\'envoi — réessayez plus tard',
    'report_status_updated': 'Votre rapport a été mis à jour',
    'reports_sent': 'Rapports envoyés',
    'status_new': 'Reçu', 'status_investigating': 'En cours', 'status_fixed': 'Corrigé', 'status_closed': 'Fermé',
  },
  'en': {
    ...
    'add_item': 'Add an item', 'clear_checked': 'Clear checked', 'clear_list': 'Clear list', 'clear_list_confirm': 'Clear the whole list?', 'items': 'items', 'item': 'item',
    'to_buy': 'To buy', 'in_cart': 'In cart',
    'my_list': 'My list', 'send_list': 'Send list', 'send_to_friend': 'Send to a friend',
    'send_confirm_title': 'Send the list?', 'send_confirm_body': 'Send your grocery list to @name?',
    'sent_to': 'Sent to', 'list_received_title': 'Grocery list received',
    'list_received_body': '@name sent you a grocery list.',
    'delete_list': 'Delete this list', 'delete_list_confirm': 'Delete this list?',
    'list_frozen_note': 'Sent list (read-only)',
    'send_offline': 'Couldn\'t send — check your connection.', 'send_empty': 'The list is empty.',
    'list_sent': 'List sent to @name', 'no_friends_yet': 'No friends yet.',
    ...
    'import_photo_max': 'Up to 5 images.',
    'import_err_multi_needs_online': 'Multi-image import needs an online provider — add an API key in Advanced settings.',
    ...
    // crash reporting
    'crop_failed': 'Couldn\'t crop the photo',
    'photo_recovered': 'Photo recovered',
    'crash_banner': 'Looks like the app crashed — send a report?',
    'crash_banner_send': 'Send',
    'report_problem': 'Report a problem',
    'report_title': 'Report a problem',
    'report_notes_ph': 'Describe what happened (optional)',
    'report_log_hint': 'An anonymous technical log will be attached',
    'report_send': 'Send report',
    'report_offline': 'You need to be online to send',
    'report_sent': 'Thanks! Report sent',
    'report_failed': 'Send failed — try again later',
    'report_status_updated': 'Your report was updated',
    'reports_sent': 'Sent reports',
    'status_new': 'Received', 'status_investigating': 'Investigating', 'status_fixed': 'Fixed', 'status_closed': 'Closed',
  },
};
