...
const Map<String, Map<String, String>> kI18n = {
  'fr': {
    ...
    'ondevice_model': 'Modèle sur l\'appareil', 'ondevice_model_none': 'Aucun modèle chargé',
    'ondevice_model_loaded': 'Modèle chargé', 'ondevice_import_file': 'Importer un fichier',
    'ondevice_download': 'Télécharger', 'ondevice_url_ph': 'https://…/model.task',
    'ondevice_delete_model': 'Supprimer le modèle', 'ondevice_downloading': 'Téléchargement…',
    'ondevice_model_hint': 'Chargez un modèle .task compatible MediaPipe (Gemma ou Qwen, ≈ 1–3 Go). Tout reste sur l\'appareil — aucune donnée n\'est envoyée.',
    'ondevice_importing': 'Importation…', 'ondevice_template': 'Format du modèle', 'ondevice_context': 'Contexte (jetons)',
    ...
    'ondevice_unsupported': 'Non pris en charge sur cet appareil (nécessite l\'IA sur appareil).',
  ...
  'en': {
    ...
    // On-device model manager (Tier 1, MediaPipe)
    'ondevice_model': 'On-device model', 'ondevice_model_none': 'No model loaded',
    'ondevice_model_loaded': 'Model loaded', 'ondevice_import_file': 'Import a file',
    'ondevice_download': 'Download', 'ondevice_url_ph': 'https://…/model.task',
    'ondevice_delete_model': 'Delete model', 'ondevice_downloading': 'Downloading…',
    'ondevice_model_hint': 'Load a MediaPipe-compatible .task model (Gemma or Qwen, ~1–3 GB). Everything stays on the device — nothing is sent anywhere.',
    'ondevice_importing': 'Importing…', 'ondevice_template': 'Model format', 'ondevice_context': 'Context (tokens)',
    ...
    'ondevice_unsupported': 'Not supported on this device (requires on-device AI).',
