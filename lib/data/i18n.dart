...
const Map<String, Map<String, String>> kI18n = {
  'fr': {
    ...
    'ondevice_model_hint': 'Chargez un modèle Gemma .task compatible MediaPipe (≈ 1–2 Go). Tout reste sur l\'appareil — aucune donnée n\'est envoyée.',
    'ondevice_importing': 'Importation…',
  ...
  'en': {
    ...
    'ondevice_model_hint': 'Load a MediaPipe-compatible Gemma .task model (~1–2 GB). Everything stays on the device — nothing is sent anywhere.',
    'ondevice_importing': 'Importing…',
