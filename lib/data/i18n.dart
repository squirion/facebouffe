...
const Map<String, Map<String, String>> kI18n = {
  'fr': {
    ...
    'import_err_ondevice_na': 'L\'IA sur appareil n\'est pas disponible sur cet appareil (modèle Gemini Nano non provisionné par AICore). Utilisez un lien ou votre clé API.',
  ...
  'en': {
    ...
    'import_err_ondevice_na': 'On-device AI isn\'t available on this device (AICore hasn\'t provisioned the Gemini Nano model). Use a link or your API key.',
